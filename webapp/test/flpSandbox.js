		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Play with NTT Data",
									"targetURL": "#comnttdatatictactoe-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnttdatatictactoe-display": {
								"semanticObject": "comnttdatatictactoe",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.nttdata.tictactoe",
									"url": sap.ui.require.toUrl("com/nttdata/tictactoe")
								}
							}
						}
					}
